                    ...
                    <one-section >
                        <div className="w-full mx-0 px-0 flex flex-col items-center justify-center">
                            <div className="w-[100%]" >
                                <Slider {...settings}>
                                    <div>
                                        <img src={banner_1} alt="Slide 1" className="w-full h-[200px] sm:h-[300px] md:h-[400px] lg:h-[600px]  rounded-lg"
                                        />
                                    </div>
                                    <div>
                                        <img src={car5} alt="Slide 2" className="w-full h-[200px] sm:h-[300px] md:h-[400px] lg:h-[600px] rounded-lg"
                                        />
                                    </div>

                                    <div>
                                        <img src={banner_4} alt="Slide 4" className="w-full h-[200px] sm:h-[300px] md:h-[400px] lg:h-[600px] rounded-lg"
                                        />
                                    </div>
                                    <div>
                                        <img src={car7} alt="Slide 5" className="w-full h-[200px] sm:h-[300px] md:h-[400px] lg:h-[600px]  rounded-lg"
                                        />
                                    </div>
                                </Slider>
                            </div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-16 ">
                                {vehicles.map((vehicle, index) => (
                                    ...
                                    >
                                        <img src={vehicle.url} alt="Vehicle" className="w-full h-[200px] sm:h-[200px] md:h-[2000px] lg:h-[200px]  rounded-lg" />
