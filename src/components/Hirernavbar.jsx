...
import { NavLink, useNavigate } from 'react-router';  // Corrected import for 'useNavigate'
...
const Hirernavbar = () => {
  ...
  const handleProfileClick = () => {
    ...
    navigate('/hirerdashboard/hirerprofile');
  };
      ...
      <nav className="navbar flex justify-between items-center bg-white !px-4 !py-2 shadow-md">
        ...
        >
          <li className="!py-2 md:!py-0 text-lg">
            <NavLink to="/hirerdashboard" className="nav-link" onClick={handleLinkClick}>
              Home
            </NavLink>
          </li>
          <li className="!py-2 md:!py-0 text-lg">
            <NavLink to="/hirerdashboard/addvehicle" className="nav-link" onClick={handleLinkClick}>
              Add Vehicle
            </NavLink>
          </li>
          <li className="!py-2 md:!py-0 text-lg">
            <NavLink to="/hirerdashboard/managevehicle" className="nav-link" onClick={handleLinkClick}>
              Manage Vehicle
            </NavLink>
          </li>
          <li className="!py-2 md:!py-0 text-lg">
